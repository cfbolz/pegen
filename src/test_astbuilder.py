...
class TestAstBuilder:
    ...
    def test_lambda(self):
        ...
        with pytest.raises(SyntaxError) as excinfo:
            self.get_ast(input)
        #assert excinfo.value.msg == 'expression cannot contain assignment, perhaps you meant "=="?' # XXX
    ...
    def xtest_string_pep3120(self): # XXX
        japan = u'日本'
    ...
    def xtest_cpython_issue12983(self): # XXX
    ...
    def xtest_asyncFunctionDef(self, with_async_hacks): # XXX
    ...
    @pytest.mark.parametrize('with_async_hacks', [False, True])
    def xtest_asyncFor(self, with_async_hacks): # XXX
    ...
    @pytest.mark.parametrize('with_async_hacks', [False, True])
    def xtest_asyncWith(self, with_async_hacks): # XXX
    ...
    @pytest.mark.parametrize('with_async_hacks', [False, True])
    def xtest_asyncYield(self, with_async_hacks): # XXX
    ...
    @pytest.mark.parametrize('with_async_hacks', [False, True])
    def xtest_asyncComp(self, with_async_hacks): ###
    ...
    def xtest_with_async_hacks(self): # XXX
    ...
    def xtest_decode_error_in_string_literal(self): # XXX
        input = "u'\\x'"
        exc = pytest.raises(SyntaxError, self.get_ast, input).value
    ...
    def xtest_decode_error_in_string_literal_correct_line(self): # XXX
        input = "u'a' u'b'\\\n u'c' u'\\x'"
        exc = pytest.raises(SyntaxError, self.get_ast, input).value
        assert exc.msg == ("(unicode error) 'unicodeescape' codec can't decode"
                           " bytes in position 0-1: truncated \\xXX escape")
    ...
    def xtest_type_comments_function_args(self): # XXX
        eq_w, w = self.space.eq_w, self.space.wrap
        module = self.get_ast(textwrap.dedent("""\
        def fa(
            a = 1,  # type: 1
    ...
    def xtest_double_type_comment(self): # XXX
    ...
    def xtest_invalid_type_comments(self): # XXX
    ...
    def xtest_end_positions(self): # XXX
        s = "a + b"
